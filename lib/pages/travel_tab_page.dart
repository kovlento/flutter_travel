...
import 'package:flutter_travel/dao/travel_dao.dart';
import 'package:flutter_travel/dao/travel_tab_dao.dart';
...
class _TravelTabPageState extends State<TravelTabPage> with AutomaticKeepAliveClientMixin{
  ...
  void _loadData ({loadMore = false}) {
    ...
    TravelDao.fetch(widget.groupChannelCode, pageIndex, PAGE_SIZE).then((TravelModel model){
      _loading=false;
      setState(() {
